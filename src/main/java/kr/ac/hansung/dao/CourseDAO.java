...
public class CourseDAO {
	...
	public List<Course> getYearAndSemesterList() {
		String sqlStatement = "select distinct year, semester from course where year!=2018";
	...
	public int getCreditByDivision(String division) {
		String sqlStatement = "select sum(credit) from course where division=? and year!=2018";
		
		return (jdbcTemplateObject.queryForObject(sqlStatement, new Object[]{division}, Integer.class));
	}
	
	public int getCompletedCredit() {
		String sqlStatement = "select sum(credit) from course where year!=2018";

		return (jdbcTemplateObject.queryForObject(sqlStatement, Integer.class));
	}

	public List<Course> getRegisteredCourses() {
		String sqlStatement = "select * from course where year=2018 and semester=1";
